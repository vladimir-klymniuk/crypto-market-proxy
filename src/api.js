...
// Service should be acting as REST API and implement its best practices. Default format for
// returned data should be JSON. Information about cryptocurrencies should be stored in database.  <-
// You should implement the following endpoints:
// 1. Get list of supported crypto currencies.                                                          // To restore 
// 2. Get price information for specific cryptocurrency(s), this endpoint also should return            // To restore 
// time of the update of each cryptocurrency.
...
// should be enough to do the task. All configuration files required to run the service should be
// provided within the code. You should provide the ability to run entire solution via Docker.
